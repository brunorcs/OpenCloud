...
logg = read.delim("log_Sur.txt", header = FALSE, stringsAsFactor = FALSE)

knitr::opts_chunk$set(
  fig.width = 8, 
  fig.height = 3, 
  fig.path = paste0('Figuras/Sur_'),
  echo = FALSE,
  include = FALSE,
  warning = FALSE,
  message = FALSE)
```
---
title: "Reporte del tiempo para la region Sur"
author: "`r logg[2,1]`"
date: "`r Sys.Date()`"
...
tmax <- read.csv("Tablas/Tmax_Sur.csv", stringsAsFactor = FALSE, na.string = '-99')
tmin <- read.csv("Tablas/Tmin_Sur.csv", stringsAsFactor = FALSE, na.string = '-99')
prec <- read.csv("Tablas/Prec_Sur.csv", stringsAsFactor = FALSE, na.string = '-99')
