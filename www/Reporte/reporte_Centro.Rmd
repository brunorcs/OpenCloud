...
logg = read.delim("log_Centro.txt", header = FALSE, stringsAsFactor = FALSE)

knitr::opts_chunk$set(
  fig.width = 8, 
  fig.height = 3, 
  fig.path = paste0('Figuras/Centro_'),
  echo = FALSE,
  include = FALSE,
  warning = FALSE,
  message = FALSE)
```
---
title: "Reporte del tiempo para la region Centro"
author: "`r logg[2,1]`"
date: "`r Sys.Date()`"
...
tmax <- read.csv("Tablas/Tmax_Centro.csv", stringsAsFactor = FALSE, na.string = "-99")
tmin <- read.csv("Tablas/Tmin_Centro.csv", stringsAsFactor = FALSE, na.string = "-99")
prec <- read.csv("Tablas/Prec_Centro.csv", stringsAsFactor = FALSE, na.string = "-99")
